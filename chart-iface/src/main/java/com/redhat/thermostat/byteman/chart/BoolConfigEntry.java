...
/**
 * Configuration entry implementation for boolean values
 *
 * @author akashche
 * Date: 6/8/15
 */
public class BoolConfigEntry extends ConfigEntryBase<Boolean> {
     ...
     * Constructor
     *
     * @param label label to display for this entry
     * @param defaultValue default value
     */
    public BoolConfigEntry(String label, boolean defaultValue) {
        super("com.redhat.thermostat.byteman.ui.swing.controls.BoolCheckboxControl", label, defaultValue);
    }
