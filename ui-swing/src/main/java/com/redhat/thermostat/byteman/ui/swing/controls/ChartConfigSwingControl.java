...
/**
 * Base class for the UI controls implementations that should display
 * specified configuration entries
 *
 * @author akashche
 * Date: 6/3/15
 */
public abstract class ChartConfigSwingControl<T extends ChartConfigEntry<?>> {
    ...
    /**
     * Implementation should return an UI widget
     *
     * @return UI widget
     */
