...
/**
 * Top level settings wrapper, holds specific settings instances
 *
 * @author akashche
 * Date: 10/20/15
 */
public class Settings {
     ...
     * Constructor
     *
     * @param system system settinfs
     * @param charts map of charts settings
     */
    ...
    /**
     * Map of charts settings accessor
     *
     * @return map of charts settings
     */
