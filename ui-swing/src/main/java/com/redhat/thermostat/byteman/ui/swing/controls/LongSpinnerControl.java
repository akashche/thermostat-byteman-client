...
/**
 * Control implementation for the long integer configuration entries
 *
 * @author akashche
 * Date: 6/3/15
 */
public class LongSpinnerControl extends ChartConfigSwingControl<LongConfigEntry> {
     ...
     *              for this control
     */
    public LongSpinnerControl(LongConfigEntry entry) {
        super(entry);
    }
