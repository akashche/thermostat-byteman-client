...
/**
 * Utility function related to chart filters
 *
 * @author akashche
 * Date: 6/30/15
 */
public class ChartFilterUtils {
    ...
    /**
     * Transforms specified filters into the list of the corresponding config entries
     *
     * @param filters set of chart filters
     * @return list of the corresponding config entries
     */
